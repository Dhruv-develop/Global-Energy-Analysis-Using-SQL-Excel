...
The dataset represents global energy statistics across regions and policy scenarios.

| Column      | Description                                          |
| ----------- | ---------------------------------------------------- |
| PUBLICATION | Source publication                                   |
| SCENARIO    | Energy scenario (Historical, Current Policies, etc.) |
| CATEGORY    | Data category                                        |
| PRODUCT     | Energy type                                          |
| FLOW        | Type of energy flow                                  |
...
* Analyze regional energy consumption trends
* Compare energy demand across different scenarios
...
* Data exploration:
  ...
  * Total record count
  * Unique regions and scenarios
  * Available year range
* Regional energy trend analysis (**Historical scenario**)
* Scenario-based energy comparison by region
* Energy level classification using **CASE statements**
* Year-on-Year growth analysis using **window functions**
...
* **Line Chart:** Energy trend over years (World)
* **Bar Chart:** Energy consumption by region (latest year)
...
* Global energy demand shows a **consistent upward trend**
* A small number of regions dominate overall energy consumption
